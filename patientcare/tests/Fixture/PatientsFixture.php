...
class PatientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'zip' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created_date' => '2017-02-18 06:03:01',
            'modified_date' => '2017-02-18 06:03:01'
        ],
    ];
}
